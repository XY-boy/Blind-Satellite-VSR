...
class Inference:
    ...
    def infer(self):
        with torch.no_grad():
            ...
            # flops, param = profile(model_small, inputs=(inputs, ))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=str, default='/home/amax/disk4/XY-Space/Deep-Blind-VSR-main/dataset/MD_testset/carbonite_BlurDown_Gaussian/GT', help='the path of input')
    parser.add_argument('--gt_path', type=str, default='/home/amax/disk4/XY-Space/Deep-Blind-VSR-main/dataset/MD_testset/carbonite_BlurDown_Gaussian/GT/', help='the path of input')
    parser.add_argument('--model_path', type=str, default='/home/amax/disk4/XY-Space/Deep-Blind-VSR-main/experiment/Deep_Blind_VSR_0211_2140/model/model_77.pt', help='the path of pretrain model')
    parser.add_argument('--result_path', type=str, default='../real/DBVSR/cb/', help='the path of result')
    ...
    parser.add_argument('--large_model', default=False, action='store_true', help='using large model if true')
